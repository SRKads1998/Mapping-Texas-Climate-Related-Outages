...
What I found was that, unfortunately, I was unable to determine a correlation between the the census tracts and areas which experienced blackouts due to my own limitations in coding. I could see that there was definite areas which had a tangible changes in illumination coverage, but I was unable to create any meaningful visuals when joining this data with the census tracts. Its possible that had the analysis worked, there may have been some a higher number of areas with lower socioeconomic standing impacted by the blackout then not, particularly since older properties are likely more susceptible to extreme weather events, but I cannot say for sure given the current status of this analysis. 
